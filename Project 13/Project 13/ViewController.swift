...
//  Project 13
//
//  Created by Andres Vazquez on 2020-02-24.
...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func save(_ sender: UIButton) {
        guard let editedImage = imageView.image else {
            let ac = UIAlertController(title: "Error", message: "No image to save. You must first select an image in order to save it.", preferredStyle: .alert)
    ...
    @objc private func image(_ image: UIImage, didFinishSavingWithError error: Error?, contextInfo: UnsafeRawPointer) {
        ...
        if let error = error {
            ...
            title = "Saved!"
            message = "Your altered image has been saved to your photo library."
        }
