...
let rendered = renderer.image { ctx in
    ...
    ctx.cgContext.addEllipse(in: CGRect(x: 400, y: 100, width: 200, height: 200))
    ctx.cgContext.addEllipse(in: CGRect(x: 100, y: 400, width: 200, height: 200))
    ctx.cgContext.addEllipse(in: CGRect(x: 700, y: 400, width: 200, height: 200))
    ctx.cgContext.addEllipse(in: CGRect(x: 400, y: 700, width: 200, height: 200))
    ctx.cgContext.drawPath(using: .fillStroke)
